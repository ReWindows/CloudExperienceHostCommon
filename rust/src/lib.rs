//! Windissect-generated Rust FFI bindings for CloudExperienceHostCommon.dll. Windows only.
...
pub const EXPECTED_PDB_GUID: &str = "2B989DB28022C5E3080B4D417CDED23D";
pub const EXPECTED_PDB_AGE: u32 = 1;
pub const EXPECTED_PE_TIMESTAMP: u32 = 3825051331;
...
mod resolver {
    ...
    pub fn base() -> usize {
        ...
        let name: [u16; 30] = [67, 108, 111, 117, 100, 69, 120, 112, 101, 114, 105, 101, 110, 99, 101, 72, 111, 115, 116, 67, 111, 109, 109, 111, 110, 46, 100, 108, 108, 0];
        ...
        if live_timestamp != 3825051331 { return 0; }
