...
static constexpr wchar_t module_name[30] = {0x0043, 0x006C, 0x006F, 0x0075, 0x0064, 0x0045, 0x0078, 0x0070, 0x0065, 0x0072, 0x0069, 0x0065, 0x006E, 0x0063, 0x0065, 0x0048, 0x006F, 0x0073, 0x0074, 0x0043, 0x006F, 0x006D, 0x006D, 0x006F, 0x006E, 0x002E, 0x0064, 0x006C, 0x006C, 0x0000};
...
if (live_timestamp != 3825051331U || rva >= image_size) return nullptr;
return base + rva;
}
