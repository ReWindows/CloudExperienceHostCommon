// Flat C exports observed in CloudExperienceHostCommon.dll. Unknown ABIs are intentionally not declared.
// Validated dialects: ISO C17/C23/C26 draft and Windissect C20 (C ABI under C++20).
#pragma once
#ifndef CLOUDEXPERIENCEHOSTCOMMON_C_H
#define CLOUDEXPERIENCEHOSTCOMMON_C_H
...
#endif
#endif // CLOUDEXPERIENCEHOSTCOMMON_C_H
